...
Form.prototype.getValues = function() {
    ...
    _.forEach(this._elements, function(element) {
        ...
        {
            if (!values[element.getBelongsTo()])
                values[element.getBelongsTo()] = {};

            values[element.getBelongsTo()][element.getName()] = element.getValue();
        }
        else
...
Form.prototype.isValidPartial = function(values, callback) {
    ...
    _.forEach(this._elements, function(element) {
        ...
        if (element.getBelongsTo())
        {
            if (_.isUndefined(values[element.getBelongsTo()]))
                skipElement = true;
            else
            {
                if (_.isUndefined(values[element.getBelongsTo()][element.getName()]))
                    skipElement = true;
                else
                    val = values[element.getBelongsTo()][element.getName()];
            }
