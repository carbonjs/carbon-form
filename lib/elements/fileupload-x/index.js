...
FileUploadX.prototype.getValue = function() {
    var value = Element.prototype.getValue.call(this);

    if (!value || (_.isArray(value) && value.length == 1 && !value[0]))
        value = [];
...
FileUploadX.prototype.getConnectWith    = function()    { return this._options.connectWith; };
...
FileUploadX.prototype.setConnectWith    = function(connectWith)     { this._options.connectWith = connectWith; };
FileUploadX.prototype.setMaxFiles       = function(maxFiles)        { this._options.maxFiles = maxFiles; };
FileUploadX.prototype.setMediaSubtype   = function(mediaSubtype)    { this._options.mediaSubtype = mediaSubtype; };
FileUploadX.prototype.setMediaType      = function(mediaType)       { this._options.mediaType = mediaType; };
FileUploadX.prototype.setStrategies     = function(strategies)      { this._options.strategies = strategies; };
