...
FileUploadX.prototype.deleteFileFromLivePath = function(value, callback) {
    request
        .post({
            url: this.getUploadEndpoint(),
            json: true,
            body: {
                action: "deleteFileToLivePath",
                value: value,
                fileUpload: {
...
FileUploadX.prototype.moveFileToLivePath = function(value, callback) {
    request
        .post({
            url: this.getUploadEndpoint(),
            json: true,
            body: {
                action: "moveFileToLivePath",
                value: value,
                fileUpload: {
                    mediaType: this.getMediaType(),
                    mediaSubtype: this.getMediaSubtype()
